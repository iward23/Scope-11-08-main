...
// There is an error because the value foo is being called outside of the for loop.
...
//Both print statements compile because the variable x is a global variable because it is initialized outside of the for loop.
...
greeting(greeting: nil, name: "Imani")
greeting(greeting: "HELLO", name: "Jake")
